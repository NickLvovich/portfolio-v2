...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    const users = [
      { id: 11, firstName: 'Nikola', lastName: 'Shilov', email: 'kol-3cl@outllok.com', password: 'lol' },
      { id: 12, firstName: 'Boris', lastName: 'Shilov', email: 'kol-2cl@outllok.com', password: 'lol1'  },
    ];
    return {users};
  }
